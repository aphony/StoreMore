...
public class sm_localization {
	...
	private static void load(String path, String default_language) {
		...
		try {
			...
			langStream = sm_localization.class.getResourceAsStream(path + default_language + ".properties");
			...
			langStream = sm_localization.class.getResourceAsStream(path + getCurrentLanguage() + ".properties");
			if (langStream != null) {
				modMappings.clear();
				modMappings.load(langStream);
			}
			...
			if (modMappings.containsKey("language.parent")) {
				langStream = sm_localization.class.getResourceAsStream(path + modMappings.get("language.parent") + ".properties");
