package mods.storemore.machine.tileentities;

import mods.storemore.StoreMore;
import mods.storemore.machine.BlockNotifyType;
import mods.storemore.machine.BlockSuperCompressor;
...
public class TileSuperCompressor extends TileEntity implements IInventory,
ISidedInventory
	{
...
*/
	public void updateEntity()
	{
		...
		if (!this.worldObj.isRemote)
		{
			...
			{
				flag1 = true;
				int metadata = BlockSuperCompressor
						.unmarkedMetadata(this.worldObj.getBlockMetadata(
								this.xCoord, this.yCoord, this.zCoord));
				if (this.furnaceBurnTime > 0)
					this.worldObj.setBlockMetadataWithNotify(this.xCoord,
							this.yCoord, this.zCoord,
							BlockSuperCompressor.setActiveOnMetadata(metadata),
							BlockNotifyType.ALL);
				else
					this.worldObj.setBlockMetadataWithNotify(this.xCoord,
							this.yCoord, this.zCoord,
...
*/
	private boolean canSmelt()
	{
		...
		{
			ItemStack itemstack = superCompressorRecipes.smelting()
...
*/
	public static int getItemBurnTime(ItemStack par0ItemStack)
	{
		...
		} else
		{
			...
			if (i == StoreMore.packedcoalI.blockID)
				return 8000;
			else if (i == StoreMore.packedcoalII.blockID)
				return 83000;
			else if (i == StoreMore.packedcoalIII.blockID)
				return 860000;
			else if (i == StoreMore.packedcoalIV.blockID)
				return 9000000;
			else if (i == StoreMore.packedcharcoalI.blockID)
				return 5800;
			else if (i == StoreMore.packedcharcoalII.blockID)
				return 65000;
			else if (i == StoreMore.packedcharcoalIII.blockID)
				return 800000;
			else if (i == StoreMore.packedcharcoalIV.blockID)
				return 8200000;
