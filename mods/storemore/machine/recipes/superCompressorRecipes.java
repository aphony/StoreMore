package mods.storemore.machine.recipes;
...
public class superCompressorRecipes extends StoreMore
{
	private static final superCompressorRecipes smeltingBase = new superCompressorRecipes();
	 ...
	 */
	public static final superCompressorRecipes smelting()
	{
		return smeltingBase;
	}

	public superCompressorRecipes()
	{

		this.addSmelting(StoreMore.packedblocksI.blockID, 0, new ItemStack(
				Block.stone, 9), 0.7F);
	}
