...
{
    private TileSuperCompressor furnaceInventory;

    public GuiSuperCompressor(InventoryPlayer par1InventoryPlayer, TileSuperCompressor par2TileSuperCompressor)
    {
        super(new ContainerSuperCompressor(par1InventoryPlayer, par2TileSuperCompressor));
        this.furnaceInventory = par2TileSuperCompressor;
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        this.mc.renderEngine.bindTexture("/mods/storemore/textures/gui/SuperCompressor.png");
